...
locret_134C2:
		...
		bne.s 	StartHammerCharge	; if yes, branch
		tst.b 	obVelY(a0) ; is player at the height of their first jump?
...
StartHammerCharge:
		...
		move.b	#1,(f_hammercharge).w ; set flag for charging hammer rush
		rts
