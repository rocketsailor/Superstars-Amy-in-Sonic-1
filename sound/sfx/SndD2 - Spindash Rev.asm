...
SoundD2_SpindashRev_Header:
	...
	smpsHeaderSFXChannel cFM5, SoundD2_SpindashRev_FM5,	$FE, $00

; FM5 Data
SoundD2_SpindashRev_FM5:
	smpsSetvoice        $00
...
SoundD2_SpindashRev_Loop00:
	dc.b	$04, smpsNoAttack
	smpsAlterVol        $03
	smpsLoop            $00, $10, SoundD2_SpindashRev_Loop00
	smpsStop

SoundD2_SpindashRev_Voices:
;	Voice $00
;	$34
