...
M_Got_SonicHas:	dc.b 8			; AMY HAS (generated by Selbi's text editor)
		dc.b $F8, 5, 0, 0, $CC		; A
		dc.b $F8, 5, 0, $2A, $DC	; M
		dc.b $F8, 5, 0, $4A, $EC	; Y
...
Art_SpinDashDust:	binclude	"artunc/spindust.bin"
		even
